...
<div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Jeśli chcesz zakończyć bieżącą sesję, wybierz opcję "Wyloguj" poniżej.</div>
            <div class="modal-footer">
                <button class="btn btn-secondary" type="button" data-dismiss="modal">Anuluj</button>
                <form action="<c:url value="/logout"/>" method="post" id="loginForm">
                    <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                </form>
                <a class="btn btn-primary" href="#" onclick="document.getElementById('loginForm').submit()">Wyloguj</a>
            </div>
        </div>
    </div>
</div>
