...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Dodaj fundację</h1>
    </div>
    ...
    <div class="card-body">
        ...
        <form:form action="/admin/institution/new" method="post" modelAttribute="institution">
            ...
            <input class="btn btn-primary" type="submit" value="Dodaj fundację">
